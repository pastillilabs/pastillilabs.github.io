...
//creating component Text
		...
		var _this_child1$child0 = new _globals.core.MouseArea(_this$child1)
...
//assigning font.pixelSize to (32)
			_this$child1._get('font')._replaceUpdater('pixelSize'); _this$child1._get('font').pixelSize = (32);
//assigning text to ('Hello, world!')
			_this$child1._replaceUpdater('text'); _this$child1.text = ('Hello, world!');
//assigning horizontalAlignment to (_globals.core.Text.prototype.AlignHCenter)
			_this$child1._replaceUpdater('horizontalAlignment'); _this$child1.horizontalAlignment = (_globals.core.Text.prototype.AlignHCenter);
//assigning verticalAlignment to (_globals.core.Text.prototype.AlignVCenter)
			_this$child1._replaceUpdater('verticalAlignment'); _this$child1.verticalAlignment = (_globals.core.Text.prototype.AlignVCenter);
//assigning anchors.fill to (${parent})
 ...
 * @extends {_globals.core.Object}
 */
	var TimerComponent = _globals.core.Timer = function(parent, _delegate) {
	...
	TimerPrototype.restart = function() { this._restart(); this.running = true; }
	...
	_globals.core._protoOnChanged(TimerPrototype, 'interval', (function(value) { this._restart() } ))
	_globals.core._protoOnChanged(TimerPrototype, 'repeat', (function(value) { this._restart() } ))
	_globals.core._protoOnChanged(TimerPrototype, 'running', (function(value) {
		this._restart()
		if (value && this.triggeredOnStart)
			this.triggered()
	} ))
	_globals.core._protoOn(TimerPrototype, 'triggered', (function() { if (!this.repeat) this.running = false } ))

	TimerPrototype.__create = function(__closure) {
		var $this = this;
		TimerBasePrototype.__create.call(this, __closure.__base = { })

	}
	TimerPrototype.__setup = function(__closure) {
		var $this = this;
	TimerBasePrototype.__setup.call(this, __closure.__base); delete __closure.__base
...
//assigning running to (true)
			_this$child0._replaceUpdater('running'); _this$child0.running = (true);
//assigning interval to (0)
			_this$child0._replaceUpdater('interval'); _this$child0.interval = (0);
...
//assigning source to ("img/background.jpg")
			_this$child1._replaceUpdater('source'); _this$child1.source = ("img/background.jpg");
//assigning fillMode to (_globals.core.Image.prototype.PreserveAspectCrop)
			_this$child1._replaceUpdater('fillMode'); _this$child1.fillMode = (_globals.core.Image.prototype.PreserveAspectCrop);
//assigning anchors.fill to (${parent})
			var update$_this_child1$anchors_fill = function() { _this$child1._get('anchors').fill = (_this$child1._get('parent')); }
			_this$child1._get('anchors')._replaceUpdater('fill', [update$_this_child1$anchors_fill, [[_this$child1, 'parent']]])
	var behavior__this_child1_on_opacity = new _globals.core.Animation(_this$child1)
	var behavior__this_child1_on_opacity__closure = { behavior__this_child1_on_opacity: behavior__this_child1_on_opacity }

//creating component Animation
	behavior__this_child1_on_opacity.__create(behavior__this_child1_on_opacity__closure.__closure_behavior__this_child1_on_opacity = { })


//setting up component Animation
	var behavior__this_child1_on_opacity = behavior__this_child1_on_opacity__closure.behavior__this_child1_on_opacity
	behavior__this_child1_on_opacity.__setup(behavior__this_child1_on_opacity__closure.__closure_behavior__this_child1_on_opacity)
	delete behavior__this_child1_on_opacity__closure.__closure_behavior__this_child1_on_opacity

//assigning duration to (5000)
	behavior__this_child1_on_opacity._replaceUpdater('duration'); behavior__this_child1_on_opacity.duration = (5000);

	_this$child1.setAnimation('opacity', behavior__this_child1_on_opacity);
...
//assigning width to (100)
			_this$child2._replaceUpdater('width'); _this$child2.width = (100);
//assigning anchors.top to (${parent.top})
			var update$_this_child2$anchors_top = function() { _this$child2._get('anchors').top = (_this$child2._get('parent')._get('top')); }
			_this$child2._get('anchors')._replaceUpdater('top', [update$_this_child2$anchors_top, [[_this$child2._get('parent'), 'top']]])
//assigning anchors.left to (${parent.left})
			var update$_this_child2$anchors_left = function() { _this$child2._get('anchors').left = (_this$child2._get('parent')._get('left')); }
			_this$child2._get('anchors')._replaceUpdater('left', [update$_this_child2$anchors_left, [[_this$child2._get('parent'), 'left']]])
//assigning height to (100)
			_this$child2._replaceUpdater('height'); _this$child2.height = (100);
...
//assigning source to ("img/situations_shadow.png")
			_this_child2$child0._replaceUpdater('source'); _this_child2$child0.source = ("img/situations_shadow.png");
//assigning anchors.centerIn to (${parent})
			var update$_this_child2_child0$anchors_centerIn = function() { _this_child2$child0._get('anchors').centerIn = (_this_child2$child0._get('parent')); }
			_this_child2$child0._get('anchors')._replaceUpdater('centerIn', [update$_this_child2_child0$anchors_centerIn, [[_this_child2$child0, 'parent']]])
}
